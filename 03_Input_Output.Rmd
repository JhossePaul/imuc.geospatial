...
```{r plot_sf, fig.align = "center", fig.height = 3}
...
## Algunas visualizaciones (cont.)
```{r plot_sp, fig.align="center"}
...
- `rnoaa`
- `rwunderground`
- `banxicoR` (No tiene nada que ver, LOL)
