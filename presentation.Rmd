...
```{r packages}
# install.packages(c("sp", "raster", "sf", "rgdal", "geosphere"))
library(sp)
library(raster)
library(sf)
library(rgdal)
...
## Introducción
Hasta el momento solo hemos visto acerca de las estructuras de datos. Ahora
veremos como importar datos de diferentes formatos con diferentes librerías.
En particular nos interesan las librerías:
